...
trait HasAdditionalProperties
{
    ...
    {
        $this->additional_properties[$key] = $this->mutatedPropertyValue($key, $value);
    ...
    {
        $this->additional_properties[$key] = $value;
    ...
    {
        if (
            $key && array_key_exists($key, $this->additional_properties) &&
            isset($this->additional_properties[$key])
        ) {
            return $this->additional_properties[$key];
        }
    }
    ...
    {
        return $this->getArrayableItems(array_merge($this->getAttributes(), $this->additional_properties));
    }
     ...
     * of a value on `$additional_properties` first and returns it, if one is found. Proper 
